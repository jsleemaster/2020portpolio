...
<body>
    <div id="wrap">
        ...
        <section id="main" class="section">
            <div id="mainbackground">
                ...
                <div id="skill" class="tabcontents">
                    <!--스킬 컨텐츠에 관한 내용-->
                ...
                <div id="project">
                    ...
                    <div class="project_content">
                        ...
                        <div class="moreback" onmouseenter="zoomIn('portfolio_more')"
                            onmouseleave="zoomOut('portfolio_more')">
                    ...
                    <div class="project_content">
                        ...
                        <div class="moreback" onmouseenter="zoomIn('project1_api_more')"
                            onmouseleave="zoomOut('project1_api_more')">
                            <span class="moreicon">?</span>
                        </div>
                        <div class="more" id="project1_api_more">
                            <h1>#Use_Skill</h1>
                            <p>Javascript, API, Photoshop, illustrator, Css, Ajax</p>
                        </div>
                        <p class="project_sub_title">#구현 사항</p>
                        <p class="project_coment">카카오 API와 Ajax 이용한 책 검색 구현</p>
                        ...
                        <div class="project_button">
                            ...
                            <div class="project_button1">
                                <a href="http://roeowo123.dothome.co.kr/book_api/booksearch.html" target="_blank">자세히</a>
                            </div>
                        </div>
                    ...
                    <div class="project_content">
                        ...
                        <div class="moreback" onmouseenter="zoomIn('animal_more')"
                            onmouseleave="zoomOut('animal_more')">
                            <span class="moreicon">?</span>
                        </div>
                        ...
                        <p class="project_sub_title">#구현 사항</p>
                        <p class="project_coment">예약기능,로그인,회원가입 php와 Mysql으로 구현, 구글맵을 이용한 지도 추가,
                        ...
                        <div class="project_button">
                            ...
                            <div class="project_button2">
                                <a href="http://roeowo123.dothome.co.kr/animal/animal_index.php"
                                    target="_blank">Renew</a>
                            </div>
                        </div>
                    </div>
                ...
                <div id="contact">
                    <div id="contact_header">
                        ...
                        <p>궁금하신 점은 연락해주시면 답장해드리겠습니다. <br>
                            <span>--이 사이트는 포트폴리오 제작을 위해 제작되었습니다.--</span>
                        </p>
                    </div>
                    <div id="contact_info">
                        <ul>
                    ...
                    <div id="contact_content">
                        <form name="contact_form" method="POST" action="">
                            ...
                            <div id="contact_message">
                                ...
                                <textarea name="contact_text" cols="30" rows="10" id="textbox"
                    ...
                    <!-- <div>
                                 include "./php/contact_list.php";
                            </div>             -->
                    <button type="button"
                        onclick="window.open('./php/contact_list.php','메세지 목록','scrollbars=no,resizable=no,width=510,height=400,left=300,top=300,status=no,toolbar=no')"
                        id="listbox">목록</button>
                    <button type="button" onclick="check_input();" id="submitbox">제출하기</button>
                </div>
            </div>
            <div id="imgmain2"></div>
            <div id="imgmain3"></div>
    ...
    <script defer src="./js/smjavascript.js"></script>
</body>
